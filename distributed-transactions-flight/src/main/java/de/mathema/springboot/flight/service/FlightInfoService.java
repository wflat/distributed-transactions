...
public class FlightInfoService {
  ...
  EntityEvent handleBookEvent(final EntityEvent event, final de.mathema.springboot.flight.repository.FlightInfo flightInfo) {
  ...
  EntityEvent handleCancelEvent(final EntityEvent event, final de.mathema.springboot.flight.repository.FlightInfo flightInfo) {
    final int newQuantity = flightInfo.getQuantity() + event.getEntityQuantity();
